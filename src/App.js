...
class App extends Component {
  ...
  render() {
    return (
      ...
      <Person name={this.state.persons[1].name} age={this.state.persons[1].age} changed={this.nameChangeHandler} click={this.switchNameHandler.bind(this, 'Max!')}>My hobbies: gaming</Person>
